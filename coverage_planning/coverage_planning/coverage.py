...
def main():    
    ...
    # room4_field =[[-0.28,-0.875],[-0.28,0.325],[-0.018,0.325],[-0.018,0.5],[1.75,0.5],[1.75,-0.875],[-0.28,-0.875]]

    # Ghouri_Corridor = [[3.0,1.0],[1.15,2.6],[3.25,5.1],[3.0,5.3],[3.6,6.0],[5.85,4.5],[3.0,1.0]]

    mts_field_polygon = [[-4.6,-6.8],[4.8,-6.8],[4.8,-1.5],[4.35,-1.5],[4.35,3.9],[-4.0,3.9],[-4.0,-1.4],[-4.6,-1.4],[-4.6,-6.8]]
    
    fields = [mts_field_polygon]
